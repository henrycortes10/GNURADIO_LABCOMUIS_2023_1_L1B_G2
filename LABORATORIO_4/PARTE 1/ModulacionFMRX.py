...
# Author: Cortes_Castano
# Copyright: Cortes_Castano
...
class ModulacionFMRX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fcb_range = Range(10e3, 200e3, 1e2, 100e3, 200)
        self._fcb_win = RangeWidget(self._fcb_range, self.set_fcb, "Frecuencia de corte filtro pasabajas", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fcb_win)
        self._fcTX_range = Range(50e6, 2.2e9, 1e5, 75e6, 200)
        self._fcTX_win = RangeWidget(self._fcTX_range, self.set_fcTX, "Frecuencia de Portadora TX", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fcTX_win)
        ...
        self.uhd_usrp_sink_0.set_center_freq(fcTX, 0)
    ...
    def set_fcTX(self, fcTX):
        self.fcTX = fcTX
        self.uhd_usrp_sink_0.set_center_freq(self.fcTX, 0)
