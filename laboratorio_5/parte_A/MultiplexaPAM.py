...
class MultiplexaPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fc_LPF_range = Range(1, 1000, 10, 1, 200)
        self._fc_LPF_win = RangeWidget(self._fc_LPF_range, self.set_fc_LPF, "seleccion señal RX", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fc_LPF_win)
        self._W_range = Range(0, 50, 1, 10, 200)
        self._W_win = RangeWidget(self._W_range, self.set_W, "Retarde demo", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._W_win)
        self._D4_range = Range(0, 100, 25, 0, 200)
        self._D4_win = RangeWidget(self._D4_range, self.set_D4, "seleccion señal RX", "counter_slider", int, QtCore.Qt.Horizontal)
        ...
        self._D1_win = RangeWidget(self._D1_range, self.set_D1, "Retardo1", "counter_slider", int, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fm, Am, 0, 0)
        ...
        self.connect((self.ModulacionPAM_0_2_0, 0), (self.low_pass_filter_0, 0))
        self.connect((self.ModulacionPAM_0_2_0, 0), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.ModulacionPAM_0_2_0, 0), (self.rational_resampler_xxx_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.ModulacionPAM_0_0, 0))
        ...
        self.connect((self.blocks_delay_0_1_0, 0), (self.ModulacionPAM_0_2_0, 0))
    ...
    def set_W(self, W):
        self.W = W
        self.ModulacionPAM_0_2_0.set_D(self.W)
